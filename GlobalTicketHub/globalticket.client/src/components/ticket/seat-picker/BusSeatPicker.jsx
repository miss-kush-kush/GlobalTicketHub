                ...
                <li className="state-tips seat-li">
                    <div className="state-block" style={{marginTop:"1rem"}}>
                        ...
                        <div className="state-box">
                            ...
                            <p style={{color:"#FFA99D"}}>Без кондиціонера</p>
                        </div>
                    </div>
                </li>
                <li className="seat-form seat-li">
                    <label htmlFor=""> Оберіть кількість місць
                        <br />
                        <input type="number" placeholder="Кількість місць" value={values.seats} name="seats" onChange={handleChange}/>
                    </label>
                    <div>
                        <p style={{margin:0,color:"#6F6F6F", fontFamily:"Fixel Display Light"}}>Місця на цьому рейсі реалізовуються з вільною розсадкою.</p>
                        <p style={{margin:0,color:"#6F6F6F", fontFamily:"Fixel Display Light"}}>Місце можна буде обрати по факту посадки в автобус.</p>
                    </div>
                </li>
                <li className="seat-li">
